...
public class Blood {
    ...
    public Blood(int bloodId, String donorId, int platelet, double haemoglobin, int lymphocytes, String condition) {
    ...
    public Blood(String donorId, int platelet, double haemoglobin, int lymphocytes) {
        this.donorId = donorId;
        this.platelet = platelet;
        this.haemoglobin = haemoglobin;
        this.lymphocytes = lymphocytes;
