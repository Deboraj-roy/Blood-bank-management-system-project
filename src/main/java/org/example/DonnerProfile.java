...
public class DonnerProfile {
    ...
    public DonnerProfile(User user) {
        ...
        JLabel nameVal = profileFrame.getLabel(user.getName(), 120, yValue, boxWidth+100, boxHeight);
        ...
        JButton editProfileButton = profileFrame.getButton("Update Profile", 140, yValue + 200, boxWidth, boxHeight);
